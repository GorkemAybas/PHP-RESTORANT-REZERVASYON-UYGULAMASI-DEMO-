...
echo '<br>Rezervasyonunuz başarıyla alınmıştır.
...
$mail->Username = "smtp.gmail.com"; // Mail adresimiz
...
if(!$mail->Send()){
  echo "<br><b>".$mailadresi . "</b> mail adresinize bilgilerinizi ve rezervasyon kodunuzu gönderdik. İyi eğlenceler!<br>
  (bu bir demo projedir isteyenler için mail gönderme komutları proje içerisinde yer almaktadır. )";
} else {
